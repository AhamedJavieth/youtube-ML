...
m,n=st.columns([1,10])
with m:
    st.image(r"C:\guvi final project\6248908838946324524.jpg")
#a,b=st.columns([1,10])
#with b:
final2 = final.sort_values(by='statistics.viewCount', ascending=False)
final2=final2.iloc[:10]
st.sidebar.image(r"C:\guvi final project\6248908838946324527.jpg")
...
if c is None and select_channel and query is not None:
